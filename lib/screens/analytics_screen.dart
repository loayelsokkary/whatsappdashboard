    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(error,
              style: TextStyle(color: isDark ? vc.textSecondary : const Color(0xFF475569), fontSize: 14),
      ...
      children: [
        ...
        Row(
          children: [
            ...
            IconButton(
              onPressed: _handleRefresh,
              icon: Icon(Icons.refresh_rounded, color: isDark ? vc.textMuted : const Color(0xFF64748B), size: 22),
              tooltip: 'Refresh',
            ),
          ],
        ),
  ...
  Widget _buildViewToggle() {
    ...
    return Container(
      decoration: BoxDecoration(
        color: isDark ? vc.surface : const Color(0xFFF1F5F9),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(icon, size: 16,
                color: isSelected ? Colors.white : (isDark ? vc.textMuted : const Color(0xFF64748B))),
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<DateRangeFilter>(
          value: _dateFilter,
          icon: Icon(Icons.keyboard_arrow_down, color: isDark ? vc.textMuted : const Color(0xFF64748B), size: 18),
          dropdownColor: isDark ? vc.surface : Colors.white,
          borderRadius: BorderRadius.circular(12),
          style: TextStyle(color: isDark ? vc.textPrimary : const Color(0xFF1E293B), fontSize: 13),
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.calendar_today_outlined, size: 13,
                      color: isSelected ? VividColors.cyan : (isDark ? vc.textMuted : const Color(0xFF64748B))),
                  const SizedBox(width: 8),
                  Text(filter.label, style: TextStyle(
                    color: isSelected ? (isDark ? vc.textPrimary : const Color(0xFF1E293B)) : (isDark ? vc.textSecondary : const Color(0xFF475569)),
                    fontWeight: isSelected ? FontWeight.w600 : FontWeight.w400,
                    fontSize: 13,
                  )),
                ],
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 12),
          Text('Compare', style: TextStyle(color: isDark ? vc.textSecondary : const Color(0xFF475569), fontSize: 13, fontWeight: FontWeight.w500)),
        ],
      ),
    );
  }
    ...
    return Row(
      ...
      children: [
        Text('vs', style: TextStyle(
          color: (isDark ? vc.textMuted : const Color(0xFF94A3B8)).withValues(alpha: 0.6), fontSize: 12, fontStyle: FontStyle.italic)),
        const SizedBox(width: 8),
        Container(
              ...
              items: DateRangeFilter.values.map((filter) {
                ...
                return DropdownMenuItem(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.calendar_today_outlined, size: 13,
                          color: isSelected ? VividColors.brightBlue : (isDark ? vc.textMuted : const Color(0xFF64748B))),
                      const SizedBox(width: 8),
                      Text(filter.label, style: TextStyle(
                        color: isSelected ? (isDark ? vc.textPrimary : const Color(0xFF1E293B)) : (isDark ? vc.textSecondary : const Color(0xFF475569)),
                        fontWeight: isSelected ? FontWeight.w600 : FontWeight.w400,
  ...
  Widget _buildExportButton(AnalyticsData data) {
    ...
    return PopupMenuButton<String>(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(12),
        side: BorderSide(color: isDark ? vc.border : const Color(0xFFE2E8F0)),
      ),
      ...
      itemBuilder: (_) => [
        PopupMenuItem(
          value: 'csv',
          child: Row(children: [
            Icon(Icons.table_chart_outlined, size: 16, color: isDark ? vc.textSecondary : const Color(0xFF475569)),
            const SizedBox(width: 10),
            Text('Export CSV', style: TextStyle(color: isDark ? vc.textPrimary : const Color(0xFF1E293B), fontSize: 13)),
          ]),
        ),
        PopupMenuItem(
          value: 'pdf',
          child: Row(children: [
            Icon(Icons.picture_as_pdf_outlined, size: 16, color: isDark ? vc.textSecondary : const Color(0xFF475569)),
            const SizedBox(width: 10),
...
class _ConversationsView extends StatelessWidget {
    ...
    return Column(
      ...
      children: [
        ...
        if (compareEnabled && data.comparison != null)
          ...
          _buildMutedNote(context, 'Enable comparison to see performance alerts'),
      ],
    );
  }
  ...
  Widget _buildConversionFunnel(BuildContext context, OverviewMetrics m) {
    final vc = context.vividColors;
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final labelColor = isDark ? vc.textSecondary : const Color(0xFF475569);
    final stages = [
    ...
    if (maxVal == 0) return _buildMutedNote(context, 'No conversion data yet');
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              border: idx < min(all.length, 15) - 1
                  ? Border(bottom: BorderSide(color: isDark ? vc.borderSubtle : const Color(0xFFE2E8F0)))
                  : null,
            ),
            child: Row(children: [
              Container(
              ...
              const SizedBox(width: 12),
              _waitTimePill(context, c.waitingTime, isLong: isLong, isMedium: isOverdue),
              const SizedBox(width: 12),
  ...
  Widget _waitTimePill(BuildContext context, Duration d, {required bool isLong, required bool isMedium}) {
    final vc = context.vividColors;
    final color = isLong ? VividColors.statusUrgent : isMedium ? VividColors.statusWarning : vc.textMuted;
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
      decoration: BoxDecoration(
...
class _BroadcastsView extends StatelessWidget {
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String?>(
          ...
          hint: Text('All Campaigns', style: TextStyle(color: isDark ? vc.textPrimary : const Color(0xFF1E293B), fontSize: 13)),
          icon: Icon(Icons.keyboard_arrow_down, color: isDark ? vc.textMuted : const Color(0xFF64748B), size: 18),
          dropdownColor: isDark ? vc.surface : Colors.white,
          borderRadius: BorderRadius.circular(12),
          style: TextStyle(color: isDark ? vc.textPrimary : const Color(0xFF1E293B), fontSize: 13),
  ...
  Widget _buildAllCampaignsView(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text('Overview', style: TextStyle(
          color: isDark ? vc.textPrimary : const Color(0xFF1E293B), fontSize: 20, fontWeight: FontWeight.bold)),
        const SizedBox(height: 20),
        ...
        if (data.campaigns.isEmpty)
          _buildMutedNote(context, 'No campaigns yet')
        else
          ...
          return Container(
            ...
            child: Row(children: [
              Expanded(flex: 3, child: Column(
                ...
                children: [
                  Text(c.name,
                      style: TextStyle(color: isDark ? vc.textPrimary : const Color(0xFF1E293B), fontSize: 13, fontWeight: FontWeight.w500),
                      overflow: TextOverflow.ellipsis),
                  if (c.sentAt != null)
                    Text('${c.sentAt!.day}/${c.sentAt!.month}/${c.sentAt!.year}',
                        style: TextStyle(color: isDark ? vc.textMuted : const Color(0xFF64748B), fontSize: 11)),
                ],
              )),
              Expanded(flex: 1, child: _tableCell(context, '${c.sent}')),
              Expanded(flex: 1, child: _tableCell(context, '${c.responded}')),
              Expanded(flex: 1, child: _tableCell(context, '${c.leads}')),
              Expanded(flex: 1, child: _tableCell(context,
  ...
  Widget _buildSingleCampaignView(BuildContext context) {
    ...
    if (campaign == null) return _buildMutedNote(context, 'Campaign not found');
...
BoxDecoration _cardBoxDecoration(BuildContext context, {bool isHighlight = false, Color? highlightColor}) {
  final vc = context.vividColors;
  final isDark = Theme.of(context).brightness == Brightness.dark;
  return BoxDecoration(
    ...
    border: Border.all(
      color: isHighlight
          ...
          : isDark ? vc.border : const Color(0xFFE2E8F0),
...
Widget _buildMutedNote(BuildContext context, String text) {
  final vc = context.vividColors;
  final isDark = Theme.of(context).brightness == Brightness.dark;
  return Container(
    width: double.infinity,
    ...
    child: Center(
      child: Text(text, style: TextStyle(
        color: isDark ? vc.textMuted : const Color(0xFF94A3B8), fontSize: 13)),
    ),
  );
}

Widget _tableCell(BuildContext context, String text, {Color? color, bool bold = false}) {
  final vc = context.vividColors;
  final isDark = Theme.of(context).brightness == Brightness.dark;
  return Text(text, textAlign: TextAlign.center, style: TextStyle(
    color: color ?? (isDark ? vc.textSecondary : const Color(0xFF475569)), fontSize: 13,
...
class _TableHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text(text, textAlign: center ? TextAlign.center : TextAlign.start,
        style: TextStyle(
          color: isDark ? vc.textMuted : const Color(0xFF94A3B8),
          fontSize: 11,
...
class _MetricCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final borderColor = isHighlight
        ...
        : isDark ? vc.border : const Color(0xFFE2E8F0);
    final labelColor = isDark ? vc.textMuted : const Color(0xFF64748B);
  ...
  Widget _buildChangeIndicator(bool isDark) {
    ...
    if (isGood) {
      ...
      indicatorColor = isDark ? const Color(0xFF4A5568) : const Color(0xFF94A3B8);
    }
      ...
      children: [
        ...
        if (compareLabel != null)
          Text.rich(
            TextSpan(
              children: [
                TextSpan(text: ' vs. ', style: TextStyle(color: (isDark ? const Color(0xFF4A5568) : const Color(0xFF94A3B8)).withValues(alpha: 0.5), fontSize: 10)),
                TextSpan(text: compareLabel!, style: TextStyle(color: (isDark ? const Color(0xFF4A5568) : const Color(0xFF64748B)).withValues(alpha: 0.7), fontSize: 10, fontWeight: FontWeight.w700)),
              ],
            ),
            overflow: TextOverflow.ellipsis,
          ),
        ...
        child: Container(
          ...
          child: Center(
            child: Text(_emptyStateMessage(widget.title),
                style: TextStyle(color: isDark ? vc.textMuted.withValues(alpha: 0.5) : const Color(0xFF94A3B8), fontSize: 13),
                textAlign: TextAlign.center),
          ),
        ),
      );
  ...
  void _handleRemove(LabeledCustomer customer) async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        backgroundColor: isDark ? vc.surface : Colors.white,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
        title: Text('Remove this entry?',
            style: TextStyle(color: isDark ? vc.textPrimary : const Color(0xFF1E293B), fontSize: 16, fontWeight: FontWeight.w600)),
        content: Text(
          'Remove this entry from analytics?',
          style: TextStyle(color: isDark ? vc.textSecondary : const Color(0xFF475569), fontSize: 13),
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context, false),
            child: Text('Cancel', style: TextStyle(color: isDark ? vc.textMuted : const Color(0xFF94A3B8))),
          ),
          TextButton(
    ...
    return DragTarget<LabeledCustomer>(
      ...
      builder: (context, candidateData, rejectedData) {
        ...
        return AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isHovering ? color.withValues(alpha: 0.08) : (isDark ? vc.surface : Colors.white),
            borderRadius: BorderRadius.circular(16),
            border: Border.all(
              color: isHovering ? color.withValues(alpha: 0.5) : (isDark ? vc.border : const Color(0xFFE2E8F0)),
              ...
              Expanded(
                child: items.isEmpty
                    ? Center(child: Text(
                        ...
                        style: TextStyle(color: vc.textMuted.withValues(alpha: 0.5), fontSize: 12),
                      ))
                    : ListView.separated(
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: _hovered
              ? (isDark ? vc.surfaceAlt : const Color(0xFFF1F5F9))
              : (isDark ? vc.background : const Color(0xFFF8FAFC)),
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: _hovered
...
Widget _dialogDivider(BuildContext context) {
  final vc = context.vividColors;
  final isDark = Theme.of(context).brightness == Brightness.dark;
  return Divider(height: 1, color: isDark ? vc.borderSubtle : const Color(0xFFE2E8F0));
}
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 16),
            Expanded(
              child: sorted.isEmpty ? _emptyState(context, 'No engaged customers') :
              ListView.separated(
                itemCount: sorted.length,
                separatorBuilder: (_, __) => _dialogDivider(context),
                itemBuilder: (_, i) {
                  final c = sorted[i];
                  return Padding(
                    padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 4),
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 16),
            Expanded(
              child: sorted.isEmpty ? _emptyState(context, 'No response time data') :
              ListView.separated(
                itemCount: sorted.length,
                separatorBuilder: (_, __) => _dialogDivider(context),
                itemBuilder: (_, i) {
...
class _MessagesSentDialog extends StatelessWidget {
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(
              child: agents.isEmpty && automatedCount == 0
                  ? _emptyState(context, 'No sent messages')
                  : ListView(children: [
                      ...agents.map((e) => _agentRow(context, e.key, e.value, total, VividColors.cyan, textPrimary, isDark)),
                      if (automatedCount > 0)
                        _agentRow(context, 'Automated (Broadcast)', automatedCount, total,
                            isDark ? vc.textMuted : const Color(0xFF94A3B8), textPrimary, isDark),
                    ]),
            ),
          ]),
        ),
  ...
  Widget _agentRow(BuildContext context, String name, int count, int total, Color color, Color textPrimary, bool isDark) {
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 16),
            Expanded(
              child: customers.isEmpty ? _emptyState(context, 'No inbound messages') :
              ListView.separated(
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 16),
            Expanded(
              child: sorted.isEmpty ? _emptyState(context, 'No conversations') :
              ListView.separated(
                itemCount: sorted.length,
                separatorBuilder: (_, __) => _dialogDivider(context),
                itemBuilder: (_, i) {
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 16),
            Expanded(
              child: all.isEmpty ? _emptyState(context, 'No leads yet') :
              ListView.separated(
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 12),
            Expanded(
              child: withRevenue.isEmpty ? _emptyState(context, 'No revenue yet') :
              ListView.separated(
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 16),
            Expanded(
              child: sorted.isEmpty ? _emptyState(context, 'No campaigns') :
              ListView.separated(
                itemCount: sorted.length,
                separatorBuilder: (_, __) => _dialogDivider(context),
                itemBuilder: (_, i) {
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 16),
            Expanded(
              child: all.isEmpty ? _emptyState(context, 'No responses yet') :
              ListView.separated(
                itemCount: all.length,
                separatorBuilder: (_, __) => _dialogDivider(context),
                itemBuilder: (_, i) {
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 16),
            Expanded(
              child: recipients.isEmpty ? _emptyState(context, 'No recipients') :
              ListView.separated(
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 16),
            Expanded(
              child: sorted.isEmpty ? _emptyState(context, 'No responses yet') :
              ListView.separated(
                itemCount: sorted.length,
                separatorBuilder: (_, __) => _dialogDivider(context),
                itemBuilder: (_, i) {
