...
import '../widgets/vivid_insights_panel.dart';
      ...
      children: [
        ...
        Expanded(
          child: !_isPreviewReady
              ? const Center(child: CircularProgressIndicator(color: VividColors.cyan, strokeWidth: 2))
              : MultiProvider(
                  providers: [
                  ...
                  child: IndexedStack(
                    ...
                    children: [
                      ...
                      VividInsightsPanel(client: widget.client),
                    ],
                  ),
                ),
        ),
